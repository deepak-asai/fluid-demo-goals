...
import "./output.css";
import { ReactAppV2 } from "./react_appv2.js";
...
import { GoalList, treeConfigurationV2 } from "./schema_v2.js";
...
async function signedInStart(msalInstance: PublicClientApplication, account: AccountInfo) {
	...
	const appData = container.initialObjects.appData.viewWith(
		treeConfigurationV2, // This is defined in schema.ts
	);
	...
	root.render(<ReactAppV2 data={appData} />);
